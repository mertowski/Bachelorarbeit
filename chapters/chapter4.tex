...
Im Nachfolgenden werden Sql Injektion mit Kali Linux nach dem Tutorial von \cite{ramadhan17sqlinj} beschrieben.
...
Die kopierte URL wird in Adressleiste eingegeben, um die Realisierung des XSS-Angriffs durh das Senden einer kurzen und relativ harmlosen Nachricht oder Warnung an den Client.
