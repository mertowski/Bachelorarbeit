...
\subsection{Brute-Forcing-Passwörter mit THC-Hydra}
...
\subsection{XML External Entities (XXE) - Attacke}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=12cm]{xxeattacke2.jpg}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{xxeattacke6.jpg}
